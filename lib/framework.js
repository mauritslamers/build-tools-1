...
Framework.sproutcoreFrameworks = function(options) {
  ...
  if (this._sproutcoreFrameworks === undefined) {    
    ...
    list = ['runtime', 'jquery', 'foundation', 'datastore', 'desktop', 'animation'];
    try { // backwards compatability: check whether jquery exists and if not, take the old sc frameworks list.
      stat = fs.statSync('frameworks/sproutcore/frameworks/jquery');
    }
    catch(e) { list = ['runtime', 'foundation', 'datastore', 'desktop', 'animation']; }
