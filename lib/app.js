...
exports.App = Framework.extend({
  ...
  _performSave: function(){
    ...
    html.content = this.rootContent(
      ['<link href="' + this.urlPrefix + _sc_.get('url') + '.css" rel="stylesheet" type="text/css">',
       '<link href="' + this.urlPrefix + mainBundle.get('url') + '.css" rel="stylesheet" type="text/css">'].join("\n"),
