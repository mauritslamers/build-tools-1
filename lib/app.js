...
exports.App = Framework.extend({
  ...
  rootContent: function(htmlStylesheets, htmlScripts){
    ...
    return function(callback){
      ...
      if (!htmlStylesheets) {
        me.frameworks.getEach('orderedStylesheets').forEach(function(stylesheet){
      ...
      if(!htmlScripts){
        me.frameworks.getEach('orderedScripts').forEach(function(script){
