...
exports.App = Framework.extend({
  ...
  _performSave: function(){
    var me = this,
        ...
        bundles = {},
        mainBundle = Bundle.create({ name: this.name, buildPath: this.buildPath, buildVersion: this.buildVersion });
    ...
    this._frameworks.forEach(function(fw){
      ...
      else mainBundle.add(fw.get('orderedScripts'), fw.get('orderedStylesheets'), fw.get('resources')); 
    });
    
    // before saving the main bundle, we have to add the bundle info up front
    mainBundle.orderedScripts.unshift(this._createBundleFile(bundles));
