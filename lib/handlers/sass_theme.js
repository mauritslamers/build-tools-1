...
exports.RewriteTheme = Handler.extend({
  ...
  finish: function(request,r,callback){
    ...
    this.getThemeFile(this._file, function(err,themedata){
      ...
      tmptheme = !me.theme? "": (me.theme[0] === ".")? me.theme: "." + me.theme; // if theme is undefined, theme is an empty string, else themename

      var fallbacktheme = '$theme: "' + tmptheme + '";\n';
      var css = themedata? themedata + "\n" + r.data: fallbacktheme + r.data;
