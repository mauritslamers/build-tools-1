...
exports.File = SC.Object.extend({
  ...
  url: function(){
    return this.framework.urlFor(this.path);
  }.property(),
  ...
  content: function(callback){
    qfs.readFile(this.get('path'),callback);
  },
  
  createDirectory: function(path){
    var prefix = tools.path.dirname(path);
    
    if(prefix !== "." && prefix !== "/"){
      this.createDirectory(prefix);
    }
    // make async!
    try {
      tools.fs.mkdirSync(path, parseInt('0755',8));
    }
    catch(e){
